...
invisible(dev.off())
```
![](`r here::here("docs/figure/Figures.Rmd/figure1-1/","figure1.png")`)
...
invisible(dev.off())
```
![](`r here::here("docs/figure/Figures.Rmd/figure2-1/","figure2.png")`)
...
invisible(dev.off())
```
![](`r here::here("docs/figure/Figures.Rmd/figure3-1/","figure3.png")`)
...
invisible(dev.off())
```
![](`r here::here("docs/figure/Figures.Rmd/figure4-1/","figure4.png")`)
...
invisible(dev.off())
```
![](`r here::here("docs/figure/Figures.Rmd/figure5-1/","figure5.png")`)
...
invisible(dev.off())
```
![](`r here::here("docs/figure/Figures.Rmd/figure6-1/","figure6.png")`)
...
invisible(dev.off())
```
![](`r here::here("docs/figure/Figures.Rmd/figure7-1/","figure7.png")`)
