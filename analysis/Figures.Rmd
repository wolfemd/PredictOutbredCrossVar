...
```{r figure2, warning=F}
pngfile <- fs::path(knitr::fig_path(),  "figure2.png")
...
```{r figure3, warning=F}
pngfile <- fs::path(knitr::fig_path(),  "figure3.png")
agg_png(pngfile, width = 17.8, height = 8.9, units = "cm", res = 300, scaling = 0.9)
...
```{r figure4}
pngfile <- fs::path(knitr::fig_path(),  "figure4.png")
agg_png(pngfile, width = 17.8, height = 11.13, units = "cm", res = 300, scaling = 0.9)
...
```{r figure5}
pngfile <- fs::path(knitr::fig_path(),  "figure5.png")
...
```{r figure6}
pngfile <- fs::path(knitr::fig_path(),  "figure6.png")
...
pngfile <- fs::path(knitr::fig_path(),  "figure7.png")
